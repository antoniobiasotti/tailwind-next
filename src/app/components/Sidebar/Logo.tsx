export function Logo() {
  return (
    <strong className="flex items-center gap-2 text-xl font-semibold text-zinc-900">
      ...
      >
        <g filter="url(#filter0_dd_21001_307)">
          <g clipPath="url(#clip0_21001_307)">
            ...
            <rect
              ...
              height={32}
              rx={8}
              fill="url(#paint0_linear_21001_307)"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            <path
              ...
              fill="#D0D5DD"
            />
            <g filter="url(#filter1_dd_21001_307)">
              <circle
                cx={19}
                cy={18}
                r={8}
                fill="url(#paint1_linear_21001_307)"
              />
            </g>
            <g filter="url(#filter2_b_21001_307)">
              <path
